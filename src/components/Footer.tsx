...
export default function Footer() {
  return (
    <footer className="bg-dark-800 border-t border-dark-600 py-14 px-4">
      {/* Linha vermelha de topo */}
      <div className="h-px bg-razor-500/40 mb-14 max-w-6xl mx-auto" />
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <h4 className="font-ui font-bold text-gold-400 uppercase tracking-stamp text-xs mb-5">
            Horário
          </h4>
          <ul className="font-sans text-cream-400 text-sm space-y-2.5">
            ...
            <li className="flex justify-between gap-4">
              <span>Domingo</span>
              <span className="text-razor-400/80">Fechado</span>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-6xl mx-auto mt-12 pt-6 border-t border-dark-600 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="font-sans text-dark-400 text-xs">
